...
_DISCORD: str = 'https://discord.gg/s44CFagYN2'
_DISCORD_SVG: str = """
...
_GITHUB: str = 'https://github.com/lmaotrigine/dice-parser'
_GITHUB_SVG: str = """
...
project = 'dice-parser'
copyright = '2022, lmaotrigine'
author = 'lmaotrigine'

with open('../dice_parser/__init__.py') as f:
